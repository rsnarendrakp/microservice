...
public class UserController {
    ...
    @PostMapping
    @ApiOperation(value = "Create user details in the System")
    @ApiResponses(value = {
    ...
    @GetMapping
    @ApiOperation(value = "Returns list of users", response=List.class)
    @ApiResponses(value = {
    ...
    @GetMapping(value="/{id}")
    @ApiOperation(value = "Return user for provided Id", response = User.class)
